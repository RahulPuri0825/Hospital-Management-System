...
<nav class="navbar navbar-expand-lg navbar-dark  bg-success">
	<div class="container-fluid">
		...
		<a class="navbar-brand" href="index.jsp"><i class="fa-solid fa-house-chimney-medical"></i><b>MEDIVED HOME</b></a>
		...
		<li class="nav-item"><a class="nav-link active"
				...
				<li class="nav-item"><a class="nav-link active"
					...
					<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="user_login.jsp">USER</a></li></c:if>
